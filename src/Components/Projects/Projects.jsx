    ...
    <div id="Projects" className="p-10 md:p-24 text-white">
      ...
      <div className="py-12 px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        <ProjectCard
          ...
          repolink="https://github.com/RAMYA-1994/Airbnb-Clone/tree/main/Client"
          repolinkBE="https://github.com/RAMYA-1994/Airbnb-Clone/tree/main/Api"
        />
        ...
        <ProjectCard
          ...
          vlink="https://client-db.vercel.app/"
          repolink="https://github.com/RAMYA-1994/client-db"
          repolinkBE="https://github.com/RAMYA-1994/server-dashboard" // No backend repo
        />

        <ProjectCard
          image={bannerImg3}
          title="Task Managemnt app"
          main=" A dynamic task management application that helps users create, assign, and track tasks efficiently. Features include priority setting, deadlines, and analytics.It features JWT authentication, password hashing with bcrypt,
           and an intuitive React UI for managing tasks efficiently."
          vlink="https://frontend-taskmanagement.vercel.app/"
          repolink="https://github.com/RAMYA-1994/frontend-taskmanagement"
          repolinkBE="https://github.com/RAMYA-1994/backend-tm" // No backend repo
        />
        ...
        <ProjectCard
          ...
          vlink="https://vercel.com/ramyas-projects-8de9c12d/client-wa"
          repolink="https://github.com/RAMYA-1994/client-wa"
          repolinkBE="https://github.com/RAMYA-1994/server-wa"
        />
      </div>
    </div>
  );
